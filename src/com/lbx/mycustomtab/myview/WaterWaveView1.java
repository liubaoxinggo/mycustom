 ...
 *
 */
public class WaterWaveView1 extends View {
    private final static int FPS = 1000 / 400;
    ...
    public WaterWaveView1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
 
    public WaterWaveView1(Context context) {
        super(context);
        init();
    }
