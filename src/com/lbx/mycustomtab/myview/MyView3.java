 ...
 *
 */
@SuppressLint("DrawAllocation") public class MyView3 extends View implements Runnable {
    /** 声明Bitmap对象 */
    Bitmap  mBitQQ  = null;
    int     BitQQwidth  = 0;
    int     BitQQheight = 0;
    ...
    public MyView3(Context context)
    {
        ...
        /** 装载资源 */
        mBitQQ = ((BitmapDrawable) getResources().getDrawable(R.drawable.ic_launcher)).getBitmap();
